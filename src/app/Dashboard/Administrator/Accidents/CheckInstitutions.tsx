...
const CheckInstitutions: React.FC<CheckInstitutionsProps> = ({ accidentId }) => {
  ...
  if (isLoading) {
    return <div className="text-center text-lg font-semibold">Loading institutions...</div>;
  }
  ...
  return (
    <div className="container mx-auto px-8 py-6">
      <h1 className="text-2xl font-bold mb-4 text-gray-800 text-center">
         ...
         Assign Institutions to Accident ID:: <span className="text-blue-500">{accidentId}</span>
        </h1>
